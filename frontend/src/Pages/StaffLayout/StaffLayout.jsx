...
import "../../styles/layouts/UserLayout.scss";
import { Avatar, Modal } from "antd";
import logo from "../../assets/Image/4M Solar Solutions Logo.png";
    ...
    <>
          ...
          {!collapsed && (
            <div className="user-info">
              ...
              <div className="user-profile-id">
                ...
                <span className="id-value">{user.leadId}</span>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="sidebar-menu">
        ...
        >
          ...
          <span className="menu-text">Request Confirmation</span>
          <DownOutlined className="submenu-arrow" />
        </div>
        ...
        <div className={`submenu-children ${enquiryOpen ? "open" : ""}`}>
          <NavLink
            ...
            onClick={closeDrawer}
          >
            <HeatMapOutlined className="submenu-icon" />
            <span>New Solar Power Plant Installation</span>
          </NavLink>
          ...
          <NavLink
            ...
            onClick={closeDrawer}
          >
            <BoxPlotOutlined className="submenu-icon" />
            <span>Solar Power Plant Service</span>
          </NavLink>
          ...
          <NavLink
            ...
            onClick={closeDrawer}
          >
            <ToolOutlined className="submenu-icon" />
            <span>Operation & Maintenance Service</span>
          </NavLink>
        </div>
        ...
        <NavLink to="trackstatus" onClick={closeDrawer} className="menu-link">
          ...
          <span className="menu-text">Records & Documents</span>
        </NavLink>
        ...
        <NavLink
          ...
          className="menu-link"
        >
          <PullRequestOutlined className="menu-icon" />
